			...
			<div class="aTable">
				...
				<div class="aRow">
					...
					<div class="aCell formTd">
						...
						<input type="text" name="data[name]" size=50 maxlength=255 value="<?php echo htmlspecialchars($data['name']); ?>"/>
				...
				<div class="aRow">
					...
					<div class="aCell formTd">
						<textarea name="data[address]" rows=4 cols=44><?php echo htmlspecialchars($data['address']); ?></textarea>
				...
				<div class="aRow">
					...
					<div class="aCell formTd">
						<input type="text" name="data[city]" size=60 maxlength=255 value="<?php echo htmlspecialchars($data['city']); ?>"/>
				...
				<div class="aRow">
					...
					<div class="aCell formTd">
						<input type="text" name="data[postCode]" size=9 maxlength=9 value="<?php echo htmlspecialchars($data['postCode']); ?>"/>
				...
				<div class="aRow">
					...
					<div class="aCell formTd">
						<input type="text" name="data[age]" size=3 maxlength=3 value="<?php echo htmlspecialchars($data['age']); ?>"/>
				...
				<div class="aRow">
					...
					<div class="aCell formTd">
						<input type="text" name="data[email]" size=50 maxlength=255 value="<?php echo htmlspecialchars($data['email']); ?>"/>
