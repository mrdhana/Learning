<!DOCTYPE html>
<!-- NOTE the use of htmlentities() instead of htmlspecialchars() -->
<head>
    <meta charset="utf-8">
...
<body topmargin="0" leftmargin="0">
    <div class="container">
		...
		<h4 style="text-align: center;">Output Escaping</h4>
		</div>
			...
			<div class="aTable">
				<div class="aRow">
					...
					<div class="aCell formTd text">
						<!-- no need to escape data generated directly by the PHP program! -->
				...
				<div class="aRow">
					...
					<div class="aCell formTd">
						<!-- this data should be escaped because it originated from outside the program -->
						<input type="text" name="data[name]" size=50 maxlength=255 value="<?php echo htmlentities($data['name']); ?>"/>
				...
				<div class="aRow">
					...
					<div class="aCell formTd">
						<textarea name="data[address]" rows=4 cols=44><?php echo htmlentities($data['address']); ?></textarea>
				...
				<div class="aRow">
					...
					<div class="aCell formTd">
						<input type="text" name="data[city]" size=60 maxlength=255 value="<?php echo htmlentities($data['city']); ?>"/>
				...
				<div class="aRow">
					...
					<div class="aCell formTd">
						<input type="text" name="data[postCode]" size=9 maxlength=9 value="<?php echo htmlentities($data['postCode']); ?>"/>
				...
				<div class="aRow">
					...
					<div class="aCell formTd">
						<input type="text" name="data[age]" size=3 maxlength=3 value="<?php echo htmlentities($data['age']); ?>"/>
				...
				<div class="aRow">
					...
					<div class="aCell formTd">
						<input type="text" name="data[email]" size=50 maxlength=255 value="<?php echo htmlentities($data['email']); ?>"/>
